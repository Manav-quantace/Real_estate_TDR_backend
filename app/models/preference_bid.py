...
class PreferenceBid(Base):
    __tablename__ = "preference_bids"
    ...
    # Tripartite preference payload for slum dweller
    ...
    __table_args__ = (
        ...
        Index("ix_preference_bid_lookup", "workflow", "project_id", "t"),
        Index("ix_preference_bid_round", "round_id"),
    )
